...
$RunDir = Join-Path $ProjectRoot "results\rate_rerun_suspicious_q5000_w4_work5000"
New-Item -ItemType Directory -Force -Path $RunDir | Out-Null

$AllResultsCsv = Join-Path $RunDir "all_results_rate_rerun_suspicious_q5000_w4_work5000.csv"
...
$Rates   = @(525000, 600000, 650000, 700000)
$Repeats = 10

Set-Location $ProjectRoot

Write-Host "SCRIPT VERSION: RATE RERUN SUSPICIOUS"
