...
INPUT_PER_RUN = RUN_DIR / "rate_rerun_suspicious_q5000_w4_work5000_per_run.csv"
OUTPUT_FINAL = RUN_DIR / "rate_rerun_suspicious_q5000_w4_work5000_final_summary.csv"

df = pd.read_csv(INPUT_PER_RUN)

GROUP_COLS = ["rate_hint", "W", "Q", "mode", "batch", "batch_wait_us", "work"]
