...
$RunDir = Join-Path $ProjectRoot "results\rate_sweep_q5000_w4_work5000"
New-Item -ItemType Directory -Force -Path $RunDir | Out-Null

$AllResultsCsv = Join-Path $RunDir "all_results_rate_sweep_q5000_w4_work5000.csv"
...
$Rates   = @(525000, 550000, 575000, 600000, 650000, 700000, 800000, 900000)
$Repeats = 5

Set-Location $ProjectRoot

Write-Host "SCRIPT VERSION: RATE SWEEP"
