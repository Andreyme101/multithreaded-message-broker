...
RUN_DIR = PROJECT_ROOT / "results" / "rate_sweep_q5000_w4_work5000"

INPUT_CSV = RUN_DIR / "all_results_rate_sweep_q5000_w4_work5000.csv"
OUTPUT_AGG = RUN_DIR / "rate_sweep_q5000_w4_work5000_aggregated.csv"
...
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_tps_vs_rate.png", dpi=150)
plt.close()
...
plt.title("mean latency vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_mean_latency_vs_rate.png", dpi=150)
plt.close()
...
plt.title("p95 vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_p95_vs_rate.png", dpi=150)
plt.close()
...
plt.title("p99 vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_p99_vs_rate.png", dpi=150)
plt.close()
...
plt.title("mean queue vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_queue_vs_rate.png", dpi=150)
plt.close()
...
plt.title("max queue vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_max_queue_vs_rate.png", dpi=150)
plt.close()
...
plt.title("drop rate vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_drop_rate_vs_rate.png", dpi=150)
plt.close()
...
plt.xlabel("input rate")
plt.ylabel("rho_eff")
plt.title("rho_eff vs input rate")
plt.grid(True)
plt.tight_layout()
plt.savefig(PLOTS_DIR / "plot_rho_eff_vs_rate.png", dpi=150)
plt.close()
